            ...
            <div class="row">
                <div class="col-md-12">
                    <ul class="menu">
                        ...
                        <li><a href="{{ route('authors') }}">Staff</a></li>
                        <li><a href="{{ route('publishers') }}">Location</a></li>
                        <li><a href="{{ route('categories') }}">Categories</a></li>
                        <li><a href="{{ route('books') }}">Inventory</a></li>
                        <li><a href="{{ route('students') }}">Students</a></li>
                        <li><a href="{{ route('book_issued') }}">Transactions</a></li>
